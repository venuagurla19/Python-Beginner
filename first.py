#integer divsion (floor division)
i = 10
j = 3
...
l = 3
result_modulo = k % l
#print("Modulo (Reminder):", result_modulo)
...
result_lest_shift = 2 << 2
#print("Bitwise left shift:", result_lest_shift) # Output: 8

#bitwise right shift (>>) operator

result_right_shift = 8 >> 2
